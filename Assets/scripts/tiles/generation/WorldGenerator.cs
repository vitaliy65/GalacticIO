...
namespace tiles
{
    ...
    public class WorldGenerator : MonoBehaviour
    {
        ...
        [SerializeField] private HexBiomeGenerator biomeGenerator;
        ...
        private void SpawnTile(int col, int row)
        {
            ...
            TileBiomes biome = HexBiomeGenerator.PickBiome(Height, heat);
            ...
            TileTypes tileType = isOreCluster ? TileTypes.Ore : TileUtils.GetTileTypeFromBiome(biome);
            ...
            tile.InitializeFromWorldGenerator(tileData, resourceData, biomeMaterial, Height, heat);
        }
